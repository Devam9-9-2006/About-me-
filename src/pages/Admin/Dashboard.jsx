      ...
      <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-8">
        {cards.map((card) => (
          ...
          >
            ...
            <h2 className="text-gray-400 mt-6">{card.title}</h2>
        ...
        <div className="bg-slate-900 rounded-2xl p-8">
          ...
          <div className="grid grid-cols-2 gap-5">
            <div className="bg-slate-800 rounded-xl p-6 text-center">
              ➕
              <p className="mt-3">Add Project</p>
            </div>

            <div className="bg-slate-800 rounded-xl p-6 text-center">
              🎓
              <p className="mt-3">Add Education</p>
            </div>

            <div className="bg-slate-800 rounded-xl p-6 text-center">
              💼
              <p className="mt-3">Add Experience</p>
            </div>

            <div className="bg-slate-800 rounded-xl p-6 text-center">
              🛠
              <p className="mt-3">Add Skills</p>
            </div>
          </div>
        </div>
      </div>
